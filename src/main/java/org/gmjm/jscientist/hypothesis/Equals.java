	...
	public Result test(String experimentName, Supplier<Object> controlSupplier, Supplier<Object> candidateSupplier)
	{
		...
		if(control == null && candidate == null)
		{
			return resultFactory.create(
				...
				experimentName,
				PASSED,
				"Control and experimental objects were both null.",
				control,
				controlRt,
				candidate,
				candidateRt);
		} else if(control == null && candidate != null)
		{
			return resultFactory.create(
				...
				experimentName,
				FAILED,
				"Control was null, but experimental was not null.",
				control,
				controlRt,
				candidate,
				candidateRt);
			...
			return resultFactory.create(
				resultType,
				experimentName,
				equal ? PASSED : FAILED, equal ? "control.equals(experimental) == true" : "control.equals(experimental) == false",
				control,
				controlRt,
				candidate,
				candidateRt);
